      ...
      {variant === "plain" && swipeable ? (
          ...
          >
            {safeSlides.map((s, i) => (
              <div key={i} className="shrink-0" style={{ width: viewportW || "100%" }}>
                ...
                <div className="mt-1 text-sm leading-relaxed text-muted">{s.subtitle}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        >
          <div key={idx} className={variant === "card" ? "animate-[arc-fade_450ms_ease-out]" : ""}>
            ...
            <div className="mt-1 text-sm leading-relaxed text-muted">{active?.subtitle}</div>
          </div>
        </div>
      )}
            ...
            return (
              <button
                ...
                className={[
                  ...
                  on ? "bg-foreground" : "bg-border-low hover:bg-border",
                ].join(" ")}
